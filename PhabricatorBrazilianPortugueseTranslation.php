...
final class PhabricatorBrazilianPortugueseTranslation extends PhutilTranslation
{
  ...
  protected function getTranslations()
  {
    return array(
      ...
      '%s Task(s)' => array('%s Tarefa', '%s Tarefas', '%s Tarefas'),

      '%s ERROR(S)' => array('ERRO', 'ERROS'),
      '%d Error(s)' => array('%d Erro', '%d Erros', '%d Erros'),
      '%d Warning(s)' => array('%d Aviso', '%d Avisos', '%d Avisos'),
      '%d Auto-Fix(es)' => array('%d Correção Automática', '%d Correções Automáticas', '%d Correções Automáticas'),
      '%d Advice(s)' => array('%d Recomendações', '%d Recomendação', '%d Recomendações'),
      '%d Detail(s)' => array('%d Detalhe', '%d Detalhes', '%d Detalhes'),

      '(%d line(s))' => array('(%d linha)', '(%d linhas)', '(%d linhas)'),

      '%d line(s)' => array('%d linha', '%d linhas', '%d linhas'),
      '%d path(s)' => array('%d путь', '%d пути', '%d путей'),
      '%d diff(s)' => array('%d изменение', '%d изменения', '%d изменений'),

      '%d Answer(s)' => array('%d Resposta', '%d Respostas', '%d Respostas'),
      'Show %d Comment(s)' => array('Mostrar %d Comentário', 'Mostrar %d Comentários', 'Mostrar %d Comentários'),

      '%s DIFF LINK(S)' => array('%s DIFF LINK', '%s DIFF LINKS'),

      'You successfully created %d diff(s).' => array(
        'Você criou %d diff com sucesso.',
        'Você criou %d diffs com sucesso.',
        'Você criou %d diffs com sucesso.',
      ),
      'Diff creation failed; see body for %s error(s).' => array(
        'Criação de diff falhou; veja o body para ler o erro.',
        'Criação de diff falhou; veja o body para ler %s erros.',
      ),
      ...
      'Show %d Lint Message(s)' => array(
        'Mostrar %d mensagem do Lint',
        'Mostrar %d mensagens do Lint',
        'Mostrar %d mensagens do Lint',
      ),
      ...
      'Conpherence' => 'Conferência',
      'Countdown' => 'Countdown',
      'Daemons' => 'Daemons',
      'Dashboard' => 'Dashboard',
      'Differential' => 'Code Review',
      'Diffusion' => 'Repositórios',
      'Diviner' => 'Diviner',
      ...
      'Files' => 'Arquivos',
      'Flags' => 'Flags',
      'Harbormaster' => 'Integração Contínua',
      'Help' => 'Ajuda',
      'Herald' => 'Геральд',
      'Legalpad' => 'Соглашения',
      'Macro' => 'Мемы',
      ...
      'High' => 'Alto',
      'Triage' => 'Triagem',
      'Needs Triage' => 'Necessita de Triagem',
      'Unbreak!' => 'Починить!',
      ...
      '%s committed %s (authored by %s).' => '%s commitou %s (autoria por %s).',
      ...
      '%s added a comment to %s.' => '%s adicionou um comentário em %s.',
      ...
      '%s updated the task description for %s.' => '%s atualizou a descrição da tarefa para %s.',
